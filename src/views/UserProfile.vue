...
<template>
  <section class="flex justify-around">
    <div>
      <h2 class="text-4xl my-6">Profile</h2>
    ...
    <div class="container max-w-2xl md:w-3/4 shadow-md rounded-md overflow-hidden">
      ...
      <div class="bg-white space-y-6">
        ...
        <div class="w-full p-4 text-gray-500 flex items-center justify-end gap-4">
          <button
            class="text-white w-full max-w-fit rounded-md text-center bg-indigo-400 py-2 px-4 inline-flex items-center focus:outline-none">
            <RefreshIcon />
            Update
          </button>
